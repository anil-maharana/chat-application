...
import { updateRoomDetails } from "../../redux/actions/room";
...
function EditRoom({
  ...
  const _updateRoom = async (data) => {
    updateRoomDetails(selectedRoom._id, {
...
EditRoom.propTypes = {
  ...
  updateRoomDetails: PropTypes.func.isRequired,
  isEditChannelDialogOpen: PropTypes.bool.isRequired,
  onEditChannelDialogClose: PropTypes.func.isRequired,
};
const mapStateToProps = (state) => ({
    selectedRoom: state.room.selectedRoom,
});
export default connect(mapStateToProps, { updateRoomDetails })(EditRoom);
